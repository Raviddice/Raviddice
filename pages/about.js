    ...
    <>
      ...
      <div className={styles.containerZero}>
        <div className={styles.containerOne}>
          <div className={styles.aboutPageProseOne}>
            {" "}
            <span className={styles.nameFont}>David Leo Rice</span> is a writer
            and animator from Northampton, MA. His interests cluster around
            metaphysical horror, dark comedy, dreams, myth, hauntings, the
            uncanniness of small towns, and the grotesque.{" "}
          </div>
          ...
          <div className={styles.photoContainer}>
            <Image
              ...
              height={260}
              layout={`fixed`}
              alt="David Leo Rice reading at Pete's Candy Store in Brooklyn, NY"
            />
          </div>
        </div>
        <br />
        ...
        <div className={styles.aboutPageProseThree}>
          ...
          <a className={styles.externalLink} href="mailto:raviddice@gmail.com">
            raviddice@gmail.com
          </a>
        </div>
        <br />
        ...
        <div className={styles.containerTwo}>
          <div className={styles.aboutPageProseFour}>
            And to subscribe to David&apos;s
            <br /> Mailing List for updates on new work, enter <br />
            your email address here:
          </div>
          <div>
            <MailchimpSubscribe url="https://raviddice.us7.list-manage.com/subscribe/post?u=b62b3010e207cb12cdace2fdc&amp;id=d2303a83bd" />
          </div>
          <br />
          <br />
        </div>
