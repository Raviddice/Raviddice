export const books = {
  the_squimbop_condition: {
    imgUrl: "/images/SquimbopCondition.jpg",
    title: "The Squimbop Condition",
    url: "the_squimbop_condition",
    thumbHeight: "820",
    thumbWidth: "710",
    projectUrl: "https://1111press.com/the-squimbop-condition",
    publicity: [
      {
        className: "blurbText",
        text: "Leaping across time, slipping between realities, and reshaping history in their wake, the enigmatic duo weaves a saga as bizarre as it is relentless. Sometimes slapstick comedians, sometimes ruthless tricksters, sometimes reluctant prophets, the Brothers shift identities, betray and resurrect each other, and leave a trail of chaos in their pursuit of an impossible mission: to bring about the Golden Age—over and over again.",
      },
      {
        className: "blurbText",
        text: "Set in a world that thrives on spectacle, where mountain retreats and flickering cinemas hold the echoes of history, The Squimbop Condition is a wild, mind-bending journey through myth, madness, and the nature of storytelling itself.",
      },
    ],
    shortText: "The Brothers Squimbop are everywhere—and nowhere.",
  },
  the_berlin_wall: {
    ...
    publicity: [
      {
        className: "blurbText",
        text: "Europe, 2020. Some claim that the Berlin Wall, once a living entity, is coming back together, its scattered pieces seeking reunion on the far side of history. The European continent trembles on the edge of total war, either in reality or deep in its own feverish imagination.",
      },
      {
        className: "blurbText",
        text: " Part present-tense apocalyptic satire and part neo-medieval phantasmagoria, David Leo Rice’s new novel presents an alternate history of the present where the Internet has become a territory unto itself and unstable factions obsessed with nationalism, liberalism, and romanticism drive one another toward a clash that could turn the very notions of refuge and culture into the ravings of a lunatic.",
      },
    ],
    shortText:
  ...
  children: {
    ...
    title:
      "Children of The New Flesh: The Early Work and Pervasive Influence of David Cronenberg",
    url: "children",
    thumbHeight: "820",
    thumbWidth: "710",
    projectUrl:
      "https://1111press.bigcartel.com/product/children-of-the-new-flesh-preorder",
    publicity: [
      {
        className: "blurbText",
        text: "New and longtime Cronenberg fans will devour this intelligent, earnest, and comprehensive tribute. - Kirkus Reviews",
      },
      {
        className: "blurbText",
        text: "Children of the New Flesh is a must-read for film fanatics and fans of David Cronenberg. Edited by Chris Kelso and David Leo Rice, this collection explores the dark peripheries of Cronenberg's influence and early work, examining a world of strangeness and mystery. – Brandon Hobson, National Book Award finalist and author of The Removed",
      },
    ],
    shortText:
  ...
  angel_house: {
    ...
    thumbWidth: "710",
    projectUrl:
      "http://www.kernpunktpress.com/store/p17/angelhouse.html?fbclid=IwAR3cxvs1UuxYWa2LYpmLRljFGnXJiQWUlUO045nKhmi6pLjLmQj4sbW9cW4",
    publicity: [
      {
        className: "blurbText",
        text: "David Leo Rice’s ANGEL HOUSE is a haunting novel—brave, astute, and strange in all the best ways. I highly recommend it! -Brandon Hobson, National Book Award finalist and author of WHERE THE DEAD SIT TALKING",
      },
      {
        className: "blurbText",
        text: "Lash yourself to the mast of your ark as you set sail for the siren song of David Leo Rice’s imagination. Make anyone else on deck promise to bind you tighter the more you beg for release. In all the angel-towns you’ve ever haunted on all the demon-shores you’ve ever died, the only map that matters is the one Rice has written. The emerging cult novelist of today's moment, he’s the reigning surrealist sorcerer of tomorrow’s century. - Steve Erickson, author of Zeroville and Shadowbahn",
      },
    ],
    shortText:
  ...
  dodge: {
    ...
    thumbWidth: "710",
    projectUrl:
      "https://www.press.alternatingcurrentarts.com/2016/12/a-room-in-dodge-city-david-leo-rice.html",
    publicity: [
      {
        className: "blurbText",
        text: "With a draftsman’s hand and a psychonaut’s eye, David Leo Rice has mapped the alien precinct in which we already live. I’ve never encountered a book so strange yet so familiar. —Joanna Ruocco, author of Dan",
      },
    ],
    shortText:
  ...
  dodge_two: {
    ...
    thumbWidth: "710",
    projectUrl:
      "https://www.press.alternatingcurrentarts.com/2020/08/a-room-in-dodge-city-2-david-leo-rice.html",
    publicity: [
      {
        className: "blurbText",
  ...
  pornme: {
    ...
    thumbWidth: "710",
    projectUrl:
      "https://publish.sweek.com/shop/index.php/catalog/product/view/id/479321/s/the-pornme-trinity-210679-publish-sweek-com/category/337/",
    publicity: [
      {
        className: "blurbText",
